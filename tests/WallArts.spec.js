...
test('E2E Journey-Mounted Photo Print', async ({ page }) => {
  ...
  // ── Step 2: Navigate to PDP ────────────────────────────────────────
  await homePage.navigateToMountedPhotoPrintProduct();
  await expect(page).toHaveURL(/photo-print-p/i);
  await expect(productPage.personaliseBtn).toBeVisible();
  console.log('✅ PDP loaded - Mounted Photo Print');
...
test('E2E Journey-Photo Print', async ({ page }) => {
  ...
  // ── Step 2: Navigate to PDP ────────────────────────────────────────
  await homePage.navigateToPhotoPrintProduct();
  await expect(page).toHaveURL(/photo-print-p/i);
  await expect(productPage.personaliseBtn).toBeVisible();
  console.log('✅ PDP loaded - Photo Print');
...
test('E2E Journey-Poster Print', async ({ page }) => {
  ...
  // ── Step 2: Navigate to PDP ────────────────────────────────────────
  await homePage.navigateToPosterPrint();
  await expect(page).toHaveURL(/poster-print-p/i);
  await expect(productPage.personaliseBtn).toBeVisible();
  console.log('✅ PDP loaded - Poster Print');
...
test('E2E Journey-Framed Photo Print', async ({ page }) => {
  ...
  // ── Step 2: Navigate to PDP ────────────────────────────────────────
  await homePage.navigateToFramedPhotoPrint();
  //await expect(page).toHaveURL(/poster-print-p/i);
  await expect(productPage.personaliseBtn).toBeVisible();
  console.log('✅ PDP loaded - Framed Photo Print');
...
test('E2E Journey-Rolled Canvas Print', async ({ page }) => {
  test.setTimeout(600000);
  const homePage = new WallArtsHomePage(page);
  const productPage = new ProductPage(page);
  const cartPage = new CartPage(page);
  ...
  // ── Step 2: Navigate to PDP ────────────────────────────────────────
  await homePage.navigateToRolledCanvasPrintProduct();
  //await expect(page).toHaveURL(/poster-print-p/i);
  await expect(productPage.personaliseBtn).toBeVisible();
  console.log('✅ PDP loaded - Rolled Canvas Print');
...
test('E2E Journey-Mounted Canvas Print', async ({ page }) => {
  ...
  // ── Step 2: Navigate to PDP ────────────────────────────────────────
  await homePage.navigateToMountedCanvasPrintProduct();
  //await expect(page).toHaveURL(/poster-print-p/i);
  await expect(productPage.personaliseBtn).toBeVisible();
  console.log('✅ PDP loaded - Rolled Canvas Print');
...
test('E2E Journey-Framed Canvas Print', async ({ page }) => {
  ...
  // ── Step 2: Navigate to PDP ────────────────────────────────────────
  await homePage.navigateToFramedCanvasPrint();
  //await expect(page).toHaveURL(/poster-print-p/i);
  await expect(productPage.personaliseBtn).toBeVisible();
  console.log('✅ PDP loaded - Framed Canvas Print');
...
test('E2E Journey-Gallery Wraped Canvas Print', async ({ page }) => {
  ...
  // ── Step 2: Navigate to PDP ────────────────────────────────────────
  await homePage.navigateToAcrylicPrints();
  //await expect(page).toHaveURL(/poster-print-p/i);
  await expect(productPage.personaliseBtn).toBeVisible();
  console.log('✅ PDP loaded - Acrylic Prints');
...
test('E2E Journey-Acrylic Print - Premium Gloss', async ({ page }) => {
  ...
  // ── Step 2: Navigate to PDP ────────────────────────────────────────
  await homePage.navigateToAcrylicPrintPremiumGlossy();
  //await expect(page).toHaveURL(/poster-print-p/i);
  await expect(productPage.personaliseBtn).toBeVisible();
  console.log('✅ PDP loaded - Acrylic Prints - Premium Gloss');
