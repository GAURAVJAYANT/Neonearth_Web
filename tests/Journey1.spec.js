...
test('User Journey - AI Generation to Checkout', async ({ page, context }) => {
  ...
  const productURL = 'https://test.neonearth.com/custom-wall-tapestry-p?variant_sku=NE-SKU-133-335&list_material_type=list_mt_satin';
  ...
  if (await page.locator('text=Spot Not Found').isVisible()) {
    ...
    await page.goto('https://test.neonearth.com/custom-wall-tapestry-p', { waitUntil: 'domcontentloaded' });
  }
