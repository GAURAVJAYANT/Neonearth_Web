...
test('E2E Journey Pillow - Square seat Cushion', async ({ page }) => {
  ...
  // Step 2: Navigate to Pillows -> Cushions -> Square Seat Cushion
...
test('E2E Journey Pillow - Round Seat Cushion', async ({ page }) => {
  ...
  // Step 2: Navigate to Pillows -> Cushions -> Round Seat Cushion
...
test('E2E Journey Pillow - Rectangle Seat Cushion', async ({ page }) => {
  ...
  // Step 2: Navigate to Pillows -> Cushions -> Rectangle Seat Cushion
...
test('E2E Journey Pillow - Bed Pillow', async ({ page }) => {
  ...
  // Step 2: Navigate to Pillows -> Bed Pillows -> Bed Pillow
